 ...
 * @author Kwinno
 */
public class Po8collect extends JavaPlugin {
	
	private Po8collectWorker worker;
    ...
    public void onEnable() {
    	...
    	worker = new Po8collectWorker(getServer(), getDataFolder());
    ...
    public boolean onCommand(CommandSender sender, Command command, String commandLabel, String[] args) {
    	...
    	if (cmd.equalsIgnoreCase("dicks")) {
    		...
    		sender.getServer().getPlayer(name).chat(judge);
    		return true;
    	}
